...
Output:
- 1_mlp_multivariate_domain_shap_values.csv
- 1_mlp_multivariate_domain_forecasts.csv
- 1_mlp_multivariate_domain_best_params.csv
...
Usage in CLI:
    python multivariate_models/mlp_multivariate_domain.py --input data_intermediate/transformed_multivariate_domain_1.csv --datecol sasdate --nlags 12 --predictor-lags 1 --start-train-months 100 --verbose
"""
...
def compute_shap_and_forecasts(
    ...
    #hidden_layer_sizes_grid = [1,6,13,28,100,(32, 16)]
    #hidden_layer_sizes_grid = [7,13,14,28]
    # activation_grid = ["relu", "tanh"]
    # alpha_grid = [1e-4, 1e-3, 1e-2, 1e-1, 1]
    #hidden_layer_sizes_grid = [(7,),(13,),(14,),(28,), (15,5)]
    #hidden_layer_sizes_grid = [(1,),(14,),(20,),(28,),(56,)]
    #hidden_layer_sizes_grid = [(1,),(14,),(20,),(28,),(56,),(100,)]

    #hidden_layer_sizes_grid = [(1,),(14,),(20,),(28,),(28,14), (100, 50)]

    # final hyperparameter grid
    hidden_layer_sizes_grid = [(1,),(7,),(14,),(20,),(28,)]#,(56,)]#(100,)]
...
def main(args):
    ...
    shap_out = args.output or "results/shap/1_mlp_multivariate_domain_shap_values.csv"
    shap_df.to_csv(shap_out, index=False)
    print(f"\nSaved SHAP values to {shap_out}")

    forecast_out = "results/forecast/1_mlp_multivariate_domain_forecasts.csv"
    forecast_df.to_csv(forecast_out, index=False)
    print(f"Saved forecasts to {forecast_out}")
          
    best_params_out = "results/forecast/1_mlp_multivariate_domain_best_params.csv"
