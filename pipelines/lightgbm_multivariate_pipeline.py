...
run_step(
    ...
    [
        sys.executable,
        "multivariate_models/lightgbm_multivariate.py",
        "--input", "data_intermediate/transformed_multivariate_1.csv",
        "--datecol", "sasdate",
        "--nlags", "12",
        "--predictor-lags", "1",
...
run_step(
    ...
    [
        ...
        "--input", "results/forecast/1_lightgbm_multivariate_forecasts.csv",
        "--model", "Multivariate LightGBM"
    ]
)
...
run_step(
    ...
    [
        ...
        "--input", "results/shap/1_lightgbm_multivariate_shap_values.csv"
    ]
)
