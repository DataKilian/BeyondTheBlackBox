...
run_step(
    ...
    [
        sys.executable,
        "univariate_models/mlp_univariate.py",
        "--input", "data_intermediate/transformed_univariate_1.csv",
        "--datecol", "sasdate",
...
run_step(
    ...
    [
        ...
        "--input", "results/forecast/1_mlp_univariate_forecasts.csv",
        "--model", "Univariate MLP"
    ]
)
...
run_step(
    ...
    [
        ...
        "--input", "results/shap/1_mlp_univariate_shap_values.csv"
    ]
)
