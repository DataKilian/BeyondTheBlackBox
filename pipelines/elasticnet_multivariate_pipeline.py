...
run_step(
    ...
    [
        sys.executable,
        "multivariate_models/elasticnet_multivariate.py",
        "--input", "data_intermediate/transformed_multivariate_1.csv",
        "--datecol", "sasdate",
        "--nlags", "12",
        "--predictor-lags", "1",
...
run_step(
    ...
    [
        ...
        "--input", "results/forecast/1_elasticnet_multivariate_forecasts.csv",
        "--model", "Multivariate Elastic Net"
    ]
)
...
run_step(
    ...
    [
        ...
        "--input", "results/shap/1_elasticnet_multivariate_shap_values.csv"
    ]
)
