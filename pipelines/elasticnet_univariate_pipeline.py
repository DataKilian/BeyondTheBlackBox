...
run_step(
    ...
    [
        sys.executable,
        "univariate_models/elasticnet_univariate.py",
        "--input", "data_intermediate/transformed_univariate_1.csv",
        "--datecol", "sasdate",
...
run_step(
    ...
    [
        ...
        "--input", "results/forecast/1_elasticnet_univariate_forecasts.csv",
        "--model", "Univariate Elastic Net"
    ]
)
...
run_step(
    ...
    [
        ...
        "--input", "results/shap/1_elasticnet_univariate_shap_values.csv"
    ]
)
