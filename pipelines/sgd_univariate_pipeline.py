...
run_step(
    ...
    [
        sys.executable,
        "univariate_models/sgd_univariate.py",
        "--input", "data_intermediate/transformed_univariate_1.csv",
        "--datecol", "sasdate",
...
run_step(
    ...
    [
        ...
        "--input", "results/forecast/1_sgd_univariate_forecasts.csv",
        "--model", "Univariate SGD Regression"
    ]
)
...
run_step(
    ...
    [
        ...
        "--input", "results/shap/1_sgd_univariate_shap_values.csv"
    ]
)
