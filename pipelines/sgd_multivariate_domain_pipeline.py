...
run_step(
    ...
    [
        sys.executable,
        "multivariate_models/sgd_multivariate_domain.py",
        "--input", "data_intermediate/transformed_multivariate_domain_1.csv",
        "--datecol", "sasdate",
        "--nlags", "12",
        "--predictor-lags", "1",
...
run_step(
    ...
    [
        ...
        "--input", "results/forecast/1_sgd_multivariate_domain_forecasts.csv",
        "--model", "DI-Multivariate SGD"
    ]
)
...
run_step(
    ...
    [
        ...
        "--input", "results/shap/1_sgd_multivariate_domain_shap_values.csv"
    ]
)
