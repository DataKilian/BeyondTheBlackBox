...
run_step(
    ...
    [
        sys.executable,
        "multivariate_models/huber_multivariate_domain.py",
        "--input", "data_intermediate/transformed_multivariate_domain_1.csv",
        "--datecol", "sasdate",
        "--nlags", "12",
        "--predictor-lags", "1",
...
run_step(
    ...
    [
        ...
        "--input", "results/forecast/1_huber_multivariate_domain_forecasts.csv",
        "--model", "DI-Multivariate Huber Regression"
    ]
)
...
run_step(
    ...
    [
        ...
        "--input", "results/shap/1_huber_multivariate_domain_shap_values.csv"
    ]
)
