"""
This script reads the screened CSV (output of variable_selection.py) and applies the standard FRED-MD transformations as suggested by McCracken & Ng (2015). Ultimately, a CSV containing the transformed variables gets saved.
3-period differences for the benchmark 3-month ahead forecasting setting get computed. For further information, please refer to the thesis.
...
- transformed_univariate_3.csv
- transformed_multivariate_3.csv
- transformed_multivariate_domain_3.csv

Usage in CLI:
    python data_handling/variable_transformation_3.py --input data_intermediate/screened_univariate.csv --output data_intermediate/transformed_univariate_3.csv
    python data_handling/variable_transformation_3.py --input data_intermediate/screened_multivariate.csv --output data_intermediate/transformed_multivariate_3.csv
    python data_handling/variable_transformation_3.py --input data_intermediate/screened_multivariate_domain.csv --output data_intermediate/transformed_multivariate_domain_3.csv
"""
...
TRANSFORM_LAG = 3  # monthly transformation span for the benchmark setup

# definition of the seven transforamtion functions (3-step differences)
...
def main():
    ...
    # drop all NA rows at the top of the dataframe, which appear due to the differences in the applied transformation (e.g. first vs. second degree differencing- compresses 4 vs. 8 values)
